...
#help to decide the value of the parameter
class resample:
    #for single cluster
    ...
    #bootstrap for gamma1 and gamma2 in the pretrain step of mean-cvar problem in Kang et al. (2019)
    def robust_level_mean_cvar(self, df_train):
        self.gamma1 = 0.005
        self.gamma2 = 0.005
        self.min_mean = R_min
